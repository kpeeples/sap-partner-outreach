package com.example.demo_dv_fuse.data.json.objects;

import org.json.JSONException;
import org.json.JSONObject;

import com.example.demo_dv_fuse.data.json.JSONParser;
...
public class FlightDetail {
	...
	public void getResults(String pIata, String pDepartTime, String pArriveTime, String pFlightDate, String pFromAirport, String pToAirport ) {
		...
		url = String.format("http://10.0.2.2:8080/odata/flight/AllFlightData(airline_iata='%s',arriveTime='%s',departTime='%s',flightDate='%s',fromAirport='%s',toAirport='%s')?$format=JSON", pIata, pArriveTime, pDepartTime, pFlightDate, pFromAirport, pToAirport);
